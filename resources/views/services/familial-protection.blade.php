    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4 offset-1">
                <br><br>
                <h1><b>Service de <span style="color:#E05C5C">protection familiale</span></b></h1>
            </div>
        ...
        <form id="myform" enctype="multipart/form-data" action="familial-protection/create" method="post">
            @csrf
